...
/**
 * Dialog para edição de planos.
 *
 * @author Alvaro
 */
public class PlanEditDialog extends javax.swing.JDialog {

	/**
	 * Serial UID.
	 */
	private static final long serialVersionUID = -4534185973234060519L;

	/**
	 * Nome do dialog.
	 */
	private static final String PLAN_EDIT_DIALOG = "PlanEditDialog";
     ...
     * Construtor padrão
     */
    public PlanEditDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        this.init();
    }
     ...
     */
    public PlanEditDialog(java.awt.Frame parent, boolean modal, Plan plan) {
        super(parent, modal);
        this.plan = plan;
    ...
    private void setDataOnFields() {
    	this.valueString = this.plan.getPrice().toString();
    	this.durationString = String.valueOf(this.plan.getDuration());
    }
    ...
    private void save() {
    	try {
			int confirm = JOptionPane.showConfirmDialog(this, Messages.CONFIRM_SAVE_CHANGES, Messages.WARNING, JOptionPane.YES_NO_OPTION);
			if (confirm == JOptionPane.YES_OPTION) {
				this.plan.setPrice(Converter.convertMoneyString(this.valueString));
				this.plan.setDuration(Integer.parseInt(this.durationString));
			...
			logger.save(e.getMessage(), e.getClass().toString(), PLAN_EDIT_DIALOG, "save");
		} catch (final ObjectBeingEditedException e) {
			JOptionPane.showMessageDialog(this, "Plano " + Messages.BEING_EDITED, Messages.ERROR, JOptionPane.ERROR_MESSAGE);
			logger.save(e.getMessage(), e.getClass().toString(), PLAN_EDIT_DIALOG, "save");
		} catch (final NumberFormatException e) {
			JOptionPane.showMessageDialog(this, Messages.MONEY_CONVERT_ERROR, Messages.WARNING, JOptionPane.WARNING_MESSAGE);
			logger.save(e.getMessage(), e.getClass().toString(), PLAN_EDIT_DIALOG, "save");
		}
    }
...
//		this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PlanEditDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PlanEditDialog dialog = new PlanEditDialog(new javax.swing.JFrame(), true);
